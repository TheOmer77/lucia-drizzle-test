...
export type SunTornadoProps = ComponentPropsWithoutRef<'svg'> & {
  animated?: boolean;
};

export const SunTornado = forwardRef<ElementRef<'svg'>, SunTornadoProps>(
  ({ animated = false, className, ...props }, ref) => (
    <svg
      {...props}
      ref={ref}
      ...
      className={cn(
        `[--bg-color-gradient:theme(colors.primary.300)]
[--bg-color-lines-end:theme(colors.primary.200)]
[--bg-color-lines-start:theme(colors.primary.200/0)]
[--bg-color-main:theme(colors.primary.500)]
dark:[--bg-color-gradient:theme(colors.primary.800)]
dark:[--bg-color-lines-end:theme(colors.primary.300)]
dark:[--bg-color-lines-start:theme(colors.primary.300/0)]
dark:[--bg-color-main:theme(colors.primary.950)]`,
        className
      )}
    >
      <rect fill='var(--bg-color-main)' width='2000' height='1500' />
      <defs>
        <radialGradient id='a' gradientUnits='objectBoundingBox'>
          <stop offset='0' stopColor='var(--bg-color-gradient)' />
          <stop offset='1' stopColor='var(--bg-color-main)' />
        </radialGradient>
        <linearGradient
          id='b'
          ...
          y2='750'
        >
          <stop offset='0' stopColor='var(--bg-color-lines-start)' />
          <stop offset='1' stopColor='var(--bg-color-lines-end)' />
        </linearGradient>
        <path
          id='s'
          fill='url(#b)'
      ...
      <g
        transform='rotate(0)'
        className={cn(
          animated && 'animate-spin-reverse [animation-duration:25s]'
        )}
      >
...
SunTornado.displayName = 'SunTornado';
